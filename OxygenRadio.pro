...
UBUNTU_TRANSLATION_DOMAIN="oxygenradio.turan-mahmudov-l"
...
aptest.commands = bash $$PWD/OxygenRadio/tests/autopilot/run
aptest.depends  = sub-OxygenRadio

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/OxygenRadio/tests/unit 
unittest.depends  = sub-OxygenRadio
